...
class STT:
    ...
    def make_totem(self, user, uol=True):
        ...
        prop_file_content = '{"parent":"item/totem"\n}'
        with open(os.path.join(self.TOTEMS_DIR, self.ASSETS_DIR, self.MINECRAFT_DIR, self.MODELS_DIR, 
                               self.ITEMS_DIR,self.TOTEM_OF_UNDYING_DIR, f"{nickname}.json"), "w+") as prop_file:
            prop_file.write(prop_file_content)
